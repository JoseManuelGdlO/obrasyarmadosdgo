...
const roleProyectosRoutes = require("./roleProyectosRoutes");
const clientesRoutes = require("./clientesRoutes");
const articulosRoutes = require("./articulosRoutes");
const maquinasRoutes = require("./maquinasRoutes");
const maquinaClasesRoutes = require("./maquinaClasesRoutes");
const maquinaTiposRoutes = require("./maquinaTiposRoutes");
...
const proyectoEstimacionesRoutes = require("./proyectoEstimacionesRoutes");
...
router.use("/role-proyectos", roleProyectosRoutes);
...
router.use("/maquina-clases", maquinaClasesRoutes);
router.use("/maquina-tipos", maquinaTiposRoutes);
...
router.use("/proyectos/:proyectoId/estimaciones", proyectoEstimacionesRoutes);
