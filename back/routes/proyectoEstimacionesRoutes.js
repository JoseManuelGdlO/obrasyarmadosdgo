...
const handleEvidenciaUpload = (req, res, next) => {
  uploadEstimacionFiles.fields(ESTIMACION_EVIDENCIA_FIELDS)(req, res, async (error) => {
    if (!error) {
...
router.post("/", requirePermission(P.PROYECTOS_EDIT), handleEvidenciaUpload, createEstimacion);
router.post(
  "/:id/fotos",
