...
const Proyecto = sequelize.define(
  "Proyecto",
  {
    ...
    cantidadContrato: { type: DataTypes.DECIMAL(15, 2), allowNull: false, defaultValue: 0 },
    modificacionContrato: { type: DataTypes.DECIMAL(15, 2), allowNull: false, defaultValue: 0 },
    fechaModificatoria: { type: DataTypes.DATEONLY, allowNull: true },
